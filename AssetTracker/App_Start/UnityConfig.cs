...
namespace AssetTracker.App_Start
{
    ...
    public class UnityConfig
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
            ...
            container.RegisterType<DbContext, AssetTrackerDB>();
            container.RegisterType<IOrganizationManager, OrganizationManager>();
            container.RegisterType<IOrganizationRepository, OrganizationDBRepository>();
            container.RegisterType<IOrganizationBranchManager, OrganizationBranchManager>();
            container.RegisterType<IOrganizationBranchRepository,OrganizationBranhDBRepository>();
